...
Blockly.Msg["CONTROLS_FLOW_STATEMENTS_TOOLTIP_CONTINUE"] = "このループの残りの部分をスキップして、ループのくり返しを続けます。";
...
Blockly.Msg["CONTROLS_REPEAT_TITLE"] = "%1 回くり返す";
Blockly.Msg["CONTROLS_REPEAT_TOOLTIP"] = "いくつかのステートメントを数回実行します。";
Blockly.Msg["CONTROLS_WHILEUNTIL_HELPURL"] = "https://github.com/google/blockly/wiki/Loops#repeat";  // untranslated
Blockly.Msg["CONTROLS_WHILEUNTIL_OPERATOR_UNTIL"] = "くり返す：終わる条件";
Blockly.Msg["CONTROLS_WHILEUNTIL_OPERATOR_WHILE"] = "くり返す：続ける条件";
...
Blockly.Msg["LISTS_REPEAT_TITLE"] = "項目%1を%2回くり返したリストを作成";
Blockly.Msg["LISTS_REPEAT_TOOLTIP"] = "与えられた値を指定された回数くり返してリストを作成。";
...
Blockly.Msg["MENU_LEFT_LIST"] = "リスト";
Blockly.Msg["MENU_LEFT_LOGIC"] = "ロジック";
Blockly.Msg["MENU_LEFT_LOOPS"] = "くり返し";
Blockly.Msg["MENU_LEFT_NUMS"] = "数字";
Blockly.Msg["MENU_LEFT_TEXT"] = "テキスト";
Blockly.Msg["MENU_LEFT_VAR"] = "変数";
Blockly.Msg["MENU_LEFT_PROCEDURE"] = "関数";
Blockly.Msg["MENU_LEFT_BAS"] = "きほん";
Blockly.Msg["MENU_LEFT_PWR"] = "パワー";
Blockly.Msg["MENU_LEFT_LOC"] = "列車";
Blockly.Msg["MENU_LEFT_TURNOUT"] = "ポイント";
Blockly.Msg["MENU_LEFT_SENSOR"] = "センサ";
Blockly.Msg["MENU_LEFT_ETC"] = "その他";
Blockly.Msg["MENU_LEFT_DECO"] = "でーこ";


Blockly.Msg["MENU_DS_POWER"] = "でんげん";
Blockly.Msg["MENU_DS_RUN"] = "はしれ";
Blockly.Msg["MENU_DS_STOP"] = "とまれ";
Blockly.Msg["MENU_DS_SPEED"] = "速度";
Blockly.Msg["MENU_DS_ADDR"] = "アドレス";
Blockly.Msg["MENU_DS_DIR"] = "走る向き";
Blockly.Msg["MENU_DS_FUNC"] = "機能";
Blockly.Msg["MENU_DS_ACTION"] = "そうさ";
Blockly.Msg["MENU_DS_Dir2"] = "向き";
Blockly.Msg["MENU_DS_ADDR"] = "アドレス";
Blockly.Msg["MENU_DS_FUNCMOM"] = "機能モメンタリ";
Blockly.Msg["MENU_DS_TURNOUT"] = "ポイント";
Blockly.Msg["MENU_DS_STR"] = "まっすぐ";
Blockly.Msg["MENU_DS_DIV"] = "ぶんき";
Blockly.Msg["MENU_DS_FWD"] = "まえ";
Blockly.Msg["MENU_DS_REV"] = "うしろ";
Blockly.Msg["MENU_DS_ON"] = "オン";
Blockly.Msg["MENU_DS_OFF"] = "オフ";
Blockly.Msg["MENU_DS_S88SENSOR"] = "在線センサ";
Blockly.Msg["MENU_DS_S88START"] = "在線センサかいし";
Blockly.Msg["MENU_DS_STRENGTH"] = "つよさ";
Blockly.Msg["MENU_DS_MP3PLAY"] = "MP3をならす";
Blockly.Msg["MENU_DS_MP3PRESET"] = "音をだす";
Blockly.Msg["MENU_DS_MP3STOP"] = "音をとめる";
Blockly.Msg["MENU_DS_PRGSTART"] = "プログラム始まり";
Blockly.Msg["MENU_DS_PRGEND"] = "プログラム終わり";
Blockly.Msg["MENU_DS_THREADSTART"] = "スレッド始まり";
Blockly.Msg["MENU_DS_THREADEND"] = "スレッド終わり";
Blockly.Msg["MENU_DS_WAIT"] = "待つ";
Blockly.Msg["MENU_DS_WAITSEC"] = "秒";
Blockly.Msg["MENU_DS_DCCMODE"] = "DCCモードにする";
Blockly.Msg["MENU_DS_MM2MODE"] = "MM2モードにする";
Blockly.Msg["MENU_DS_DECOCOMES"] = "でーこちゃんが来る";
Blockly.Msg["MENU_DS_DECOSAYS"] = "と言う";
Blockly.Msg["MENU_DS_DECOSURPRISED"] = "おどろく";
Blockly.Msg["MENU_DS_DECOGOHOME"] = "でーこちゃんが帰る";

Blockly.Msg["DLG_DS_OPENFILE"] = "ファイルから開く";
